...
import { constants, events, transactions } from "../../src/graphprotocol-utils";
import { store } from "@graphprotocol/graph-ts";

export function handleTransfer(event: TransferEvent): void {
  let collection = fetchRegistry(
    event.address,
  ...
  if (collection != null) {
    ...
    if (
      tx != null &&
      transferEntity.senderAddress !=
        "0x83c8f28c26bf6aaca652df1dbbe0e1b56f8baba2" && //Gem.xyz Aggregator
      transferEntity.senderAddress !=
        "0x0a267cf51ef038fc00e71801f5a524aec06e4f07" //Genie Aggregator
    ) {
