import { sale, transaction, currency } from "../../generated/schema";
import { MatchTransferWithSale } from "../../src/utils/matchTransferSale";
import { EvProfit } from "../../generated/X2Y2/X2Y2";
  ...
  if (tx) {
    ...
    if (!saleEntity && tx.unmatchedTransferCount > 0) {
      ...
      if (currencyEntity) {
        ...
        saleEntity.amount = event.params.amount
          .divDecimal(BigDecimal.fromString("1000000000000000000"))
          .div(BigDecimal.fromString("0.98"));
